...
public final class Util {
     ...
     */
    public static <T> T chooseRandomFromIterable(Iterable<T> iterable, int size, boolean remove) { // TODO: make this work, replace at LevelManager generateStimuliFirstPart()
